...
Netflix: <Flag variant="netflix" id="80014749" />

```jsx
<Flag variant="netflix" id="80014749" />
```

Prime Video: <Flag variant="primevideo" id="B0874XF36P" />

```jsx
<Flag variant="amazon" id="B0874XF36P" />
```
