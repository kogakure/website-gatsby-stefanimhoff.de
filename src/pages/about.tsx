      ...
      <Grid rowGap variant="fullsize">
        ...
        <Styled.SectionAbout>
          <Paragraph>
            ...
            taking photos, and
            <Emojify emoji="🖋" />
            writing <TextLink to="/haiku/">Haiku</TextLink>. I consider myself
            as a<Emojify emoji="⬜️" />
          ...
          <Paragraph noMargin>
            ...
            <TextLink href="https://book.kogakure.de/">book</TextLink> about
            Ninja and Ninjutsu – a topic that I know way too much about.
          </Paragraph>
        </Styled.SectionAbout>
        <Styled.SectionAboutWebsite>
          ...
          <Paragraph>
            ...
            projects. Don’t just steal it. Learn from it. Remix. Reuse. Build
            your own stuff.
          </Paragraph>
          <Paragraph noMargin>
        ...
        <Styled.SectionContact id="contact">
        ...
        </Styled.SectionContact>
        <Styled.SectionConnect id="connect">
