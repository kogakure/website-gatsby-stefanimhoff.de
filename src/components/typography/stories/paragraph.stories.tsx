...
export const Default = () => (
  <Paragraph>
    ...
    echo park brunch direct trade four dollar toast chartreuse, drinking vinegar
    wolf bushwick pork belly. Vexillologist sartorial literally venmo blog.
    Tumblr you probably haven't heard of them bitters swag waistcoat af. Deep v
    helvetica blog, paleo cardigan seitan kombucha normcore.
  </Paragraph>
);
